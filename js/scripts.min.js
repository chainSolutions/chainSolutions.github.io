...
$(function(){autosize($("textarea")),$(window).scroll(function(){$(this).scrollTop()>200?$("aside.fixed_left").addClass("resize"):$("aside.fixed_left").removeClass("resize")}),$("#contactForm").submit(function(e){e.preventDefault();var a=$(this),t=!1;function n(){a.find(".form-success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){a.find(".form-success").removeClass("active").fadeOut(),a.trigger("reset")},2e3)}if(a.find(".req").each(function(){$(this).removeClass("error"),""==$(this).val()&&($(this).addClass("error"),t=!0)}),t)return!1;var o=a.serialize();$.ajax({url:"https://docs.google.com/forms/d/e/1FAIpQLSdcLcQXCTR6yKhOp2vg7LJC1ODU6869FM4H4v4Zy22I86Y6Yw/formResponse",data:o,type:"POST",dataType:"xml",beforeSend:function(){a.find("button").attr("disabled")},statusCode:{0:function(){n()},200:function(){n()}}})}),$("#newsForm").submit(function(e){e.preventDefault();var a=$(this);function t(){a.find(".form-success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){a.find(".form-success").fadeOut().removeClass("active"),a.trigger("reset")},2e3)}var n=a.serialize();$.ajax({url:"https://docs.google.com/forms/d/e/1FAIpQLSc9cujV0R-CMdqSBYNXNtBxP5SxBIf5C89ArUa9YtsCWbbuiw/formResponse",data:n,type:"POST",dataType:"xml",beforeSend:function(){a.find("button").attr("disabled")},statusCode:{0:function(){t()},200:function(){t()}}})}),$(".btn-top").on("click",function(){$("html,body").animate({scrollTop:0},900)}),$(".smooth").on("click",function(e){e.preventDefault();var a=$(this).attr("href"),t=$(a).offset().top;$("body,html").animate({scrollTop:t},1e3)}),$(".join").on("mouseenter click",function(e){$(this).addClass("is-active")}),$(".join").on("mouseleave",function(){$(this).removeClass("is-active")}),$(".main-nav .nav-link_wrap").on("mouseover click",function(){$(".main-nav .nav-link_wrap").removeClass("is-active"),$(this).addClass("is-active")})}),$(window).scroll(function(){var e=$("#footer").offset().top,a=$("#footer").offset().top+$("#footer").outerHeight(),t=$(window).scrollTop()+$(window).height(),n=$(window).scrollTop();if(t>e&&n<a?$("aside.fixed_right").fadeOut():$("aside.fixed_right").fadeIn(),$("body").hasClass("page-main")){var o=$("#advantage").offset().top;$(window).scrollTop()+$(window).height()>o?$("aside .scroll-btn_down").fadeOut():$("aside .scroll-btn_down").fadeIn()}}),$(window).on("load",function(){if($(".preloader").delay(1).fadeOut("slow"),$("body").hasClass("page-main")){var e=new ScrollMagic.Controller,a=TweenMax.to("#anim1 .item-icon",1,{className:"+=is-active"}),t=TweenMax.to("#anim2 .item-icon",1,{className:"+=is-active"}),n=TweenMax.to("#anim3 .item-icon",1,{className:"+=is-active"}),o=TweenMax.to("#anim4 .item-icon",1,{className:"+=is-active"}),s=$("path#line1"),i=$("path#line2"),d=$("path#line3");function r(e){var a=e[0].getTotalLength();e.css("stroke-dasharray",a),e.css("stroke-dashoffset",a)}r(s),r(i),r(d);var c=(new TimelineMax).add(TweenMax.to(s,.9,{strokeDashoffset:2e3,ease:Linear.easeNone})).add(TweenMax.to(i,.9,{strokeDashoffset:2e3,ease:Linear.easeNone})).add(TweenMax.to(d,.9,{strokeDashoffset:2e3,ease:Linear.easeNone})).add(TweenMax.from("path",0,{strokeDashoffset:0,stroke:"#33629c",ease:Linear.easeNone}),0);new ScrollMagic.Scene({triggerElement:"#line-svg",duration:400,tweenChanges:!0}).setTween(c).addTo(e),new ScrollMagic.Scene({triggerElement:"#anim1",duration:200,tweenChanges:!0}).setTween(a).addTo(e),new ScrollMagic.Scene({triggerElement:"#anim2",duration:200,tweenChanges:!0}).setTween(t).addTo(e),new ScrollMagic.Scene({triggerElement:"#anim3",duration:200,tweenChanges:!0}).setTween(n).addTo(e),new ScrollMagic.Scene({triggerElement:"#anim4",duration:200,tweenChanges:!0}).setTween(o).addTo(e)}if(matchMedia("only screen and (max-width: 767px)").matches){var l=$(".advantages-item"),f=$(".how-item"),w=$(".s-how .s-intro h1"),m=$(".founder-item"),u=$(".s-founders .s-intro h1"),h=$(".s-subscribe form"),v=$(".s-subscribe .s-intro h1");$(".page-contacts .wow").each(function(){$(this).removeAttr("data-wow-delay")}),f.find(".item-icon").addClass("is-active"),l.add(m).each(function(){$(this).removeAttr("data-wow-delay")}),f.each(function(){$(this).addClass("wow fadeInRight")}),w.add(v).add(h).addClass("wow fadeInRight"),m.each(function(){$(this).addClass("wow fadeInLeft")}),u.addClass("wow fadeInLeft"),$(window).scroll(function(){if($("body").hasClass("page-main")){var e=$("#advantage").offset().top;$(window).scrollTop()+$(window).height()>e?$("aside.fixed_left").fadeOut():$("aside.fixed_left").fadeIn()}else{var a=$("#infoBox").offset().top;$(window).scrollTop()+$(window).height()>a?$("aside.fixed_left").fadeOut():$("aside.fixed_left").fadeIn()}})}new WOW({boxClass:"wow",animateClass:"animated",offset:0,mobile:!0,live:!0,scrollContainer:null}).init()});