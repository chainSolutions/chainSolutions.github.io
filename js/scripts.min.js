...
$(function(){autosize($("textarea")),$(window).scroll(function(){$(this).scrollTop()>200?$("aside.fixed_left").addClass("resize"):$("aside.fixed_left").removeClass("resize")}),$("#contactForm").submit(function(e){function a(){t.find(".form-success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){t.find(".form-success").removeClass("active").fadeOut(),t.trigger("reset")},2e3)}e.preventDefault();var t=$(this),n=!1;if(t.find(".req").each(function(){$(this).removeClass("error"),""==$(this).val()&&($(this).addClass("error"),n=!0)}),n)return!1;var o=t.serialize();$.ajax({url:"https://docs.google.com/forms/d/e/1FAIpQLSdcLcQXCTR6yKhOp2vg7LJC1ODU6869FM4H4v4Zy22I86Y6Yw/formResponse",data:o,type:"POST",dataType:"xml",beforeSend:function(){t.find("button").attr("disabled")},statusCode:{0:function(){a()},200:function(){a()}}})}),$("#newsForm").submit(function(e){function a(){t.find(".form-success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){t.find(".form-success").fadeOut().removeClass("active"),t.trigger("reset")},2e3)}e.preventDefault();var t=$(this),n=t.serialize();$.ajax({url:"https://docs.google.com/forms/d/e/1FAIpQLSc9cujV0R-CMdqSBYNXNtBxP5SxBIf5C89ArUa9YtsCWbbuiw/formResponse",data:n,type:"POST",dataType:"xml",beforeSend:function(){t.find("button").attr("disabled")},statusCode:{0:function(){a()},200:function(){a()}}})}),$(".btn-top").on("click",function(){$("html,body").animate({scrollTop:0},900)}),$(".smooth").on("click",function(e){e.preventDefault();var a=$(this).attr("href"),t=$(a).offset().top;$("body,html").animate({scrollTop:t},1e3)}),$(".join").on("mouseenter click",function(e){e.preventDefault(),$(this).addClass("is-active")}),$(".join").on("mouseleave touchend",function(){$(this).removeClass("is-active")}),$(".main-nav .nav-link_wrap").on("mouseover click",function(){$(".main-nav .nav-link_wrap").removeClass("is-active"),$(this).addClass("is-active")})}),$(window).scroll(function(){var e=$("#footer").offset().top,a=$("#footer").offset().top+$("#footer").outerHeight(),t=$(window).scrollTop()+$(window).height(),n=$(window).scrollTop();if(t>e&&n<a?$("aside.fixed_right").fadeOut():$("aside.fixed_right").fadeIn(),$("body").hasClass("page-main")){var o=$("#advantage").offset().top;$(window).scrollTop()+$(window).height()>o?$("aside .scroll-btn_down").fadeOut():$("aside .scroll-btn_down").fadeIn()}}),$(window).on("load",function(){function e(e){var a=e[0].getTotalLength();e.css("stroke-dasharray",a),e.css("stroke-dashoffset",a)}if($(".preloader").delay(1).fadeOut("slow"),$("body").hasClass("page-main")){var a=new ScrollMagic.Controller,t=TweenMax.to("#anim1 .item-icon",1,{className:"+=is-active"}),n=TweenMax.to("#anim2 .item-icon",1,{className:"+=is-active"}),o=TweenMax.to("#anim3 .item-icon",1,{className:"+=is-active"}),s=TweenMax.to("#anim4 .item-icon",1,{className:"+=is-active"}),i=$("path#line1"),d=$("path#line2"),r=$("path#line3");e(i),e(d),e(r);var c=(new TimelineMax).add(TweenMax.to(i,.9,{strokeDashoffset:2e3,ease:Linear.easeNone})).add(TweenMax.to(d,.9,{strokeDashoffset:2e3,ease:Linear.easeNone})).add(TweenMax.to(r,.9,{strokeDashoffset:2e3,ease:Linear.easeNone})).add(TweenMax.from("path",0,{strokeDashoffset:0,stroke:"#33629c",ease:Linear.easeNone}),0);new ScrollMagic.Scene({triggerElement:"#line-svg",duration:400,tweenChanges:!0}).setTween(c).addTo(a),new ScrollMagic.Scene({triggerElement:"#anim1",duration:200,tweenChanges:!0}).setTween(t).addTo(a),new ScrollMagic.Scene({triggerElement:"#anim2",duration:200,tweenChanges:!0}).setTween(n).addTo(a),new ScrollMagic.Scene({triggerElement:"#anim3",duration:200,tweenChanges:!0}).setTween(o).addTo(a),new ScrollMagic.Scene({triggerElement:"#anim4",duration:200,tweenChanges:!0}).setTween(s).addTo(a)}if(matchMedia("only screen and (max-width: 767px)").matches){var l=$(".advantages-item"),f=$(".how-item"),w=$(".s-how .s-intro h1"),m=$(".founder-item"),u=$(".s-founders .s-intro h1"),h=$(".s-subscribe form"),v=$(".s-subscribe .s-intro h1");$(".page-contacts .wow").each(function(){$(this).removeAttr("data-wow-delay")}),f.find(".item-icon").addClass("is-active"),l.add(m).each(function(){$(this).removeAttr("data-wow-delay")}),f.each(function(){$(this).addClass("wow fadeInRight")}),w.add(v).add(h).addClass("wow fadeInRight"),m.each(function(){$(this).addClass("wow fadeInLeft")}),u.addClass("wow fadeInLeft"),$(window).scroll(function(){if($("body").hasClass("page-main")){var e=$("#advantage").offset().top;$(window).scrollTop()+$(window).height()>e?$("aside.fixed_left").fadeOut():$("aside.fixed_left").fadeIn()}else{var a=$("#infoBox").offset().top;$(window).scrollTop()+$(window).height()>a?$("aside.fixed_left").fadeOut():$("aside.fixed_left").fadeIn()}})}new WOW({boxClass:"wow",animateClass:"animated",offset:0,mobile:!0,live:!0,scrollContainer:null}).init()});